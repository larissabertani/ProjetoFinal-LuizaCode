...
payload = {'usuario':'Larissa', 'permissoes':'admin'}
jwt_token = jwt.encode(payload, key=chave_privada, algorithm='RS256')


dados_token = jwt.decode(jwt_token, key=chave_publica, algorithms=['RS256'])
...
def valida_admin(dados_token: dict = Depends(confere_token)):
